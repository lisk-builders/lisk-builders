          ...
          <div className="modal-container">
            ...
            <div className="modal-body">
              <div className="content">
                <p>
                  <strong>Added votes:</strong> {flatVoteData.filter((v: any) => v.type === 'vote').map((v: any) => v.name).join(' ')}
                </p>
                <p>
                  <strong>Removed votes:</strong> {flatVoteData.filter((v: any) => v.type === 'unvote').map((v: any) => v.name).join(' ')}
                </p>
              </div>
            </div>
